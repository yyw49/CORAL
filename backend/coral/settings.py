...
# PostgreSQL configuration (used when running with Docker)
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.postgresql',
#         'NAME': config('POSTGRES_DB', default='coral_db'),
#         'USER': config('POSTGRES_USER', default='coral_user'),
...
LANGUAGE_CODE = 'en-us'
TIME_ZONE = 'America/Los_Angeles'  # USC is in LA
USE_I18N = True
USE_TZ = True
